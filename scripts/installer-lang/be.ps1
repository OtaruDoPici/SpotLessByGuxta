[PSCustomObject]@{
    Welcome         = "
╔════════════════════════════════════════╗
║ Сардэчна запрашаем у SpotLessByGuxta для Windows ║
╚════════════════════════════════════════╝"
    ...
    NewV2           = "Ваша версія Spotify ({0}) не была пратэставана. Стабільная версія для SpotLessByGuxta — {1}"
    ...
    Spicetify       = "Spicetify выяўлены, ён павінен быць усталяваны пасля SpotLessByGuxta, адкрыць рэкамендаваныя дзеянні ў FAQ? [Y/N]"
    NoRestore       = "SpotLessByGuxta ужо ўсталяваны, xpui.bak не знойдзены. Калі ласка, выдаліце кліент Spotify і запусціце Install.bat зноў"
