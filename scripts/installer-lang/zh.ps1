[PSCustomObject]@{
    Welcome         = "
╔════════════════════════════════╗
║ 欢迎使用 SpotLessByGuxta 的 Windows 版本 ║
╚════════════════════════════════╝"
    Incorrect       = "糟糕，不正确的参数,"
    Incorrect2      = "请重新输入 "
    Download        = "下载错误"
    ...
    Spicetify       = "检测到 Spicetify，它必须在安装 SpotLessByGuxta 后进行安装。是否启用 FAQ 中的建议操作？ [Y/N]"
    NoRestore       = "SpotLessByGuxta 已经安装，但是找不到文件 xpui.bak . `n请重新安装 Spotify 客户端后再次运行 install.bat"
