[PSCustomObject]@{
    Welcome         = "
╔══════════════════════════════════╗
║ Windows için SpotLessByGuxta'e Hoşgeldiniz ║
╚══════════════════════════════════╝"
    ...
    NoRestore       = "SpotLessByGuxta zaten kurulmuş, xpui.bak dosyası bulunamadı. `nLütfen Spotify istemcisini kaldırın ve Install.bat dosyasını tekrar çalıştırın"
