[PSCustomObject]@{
    Welcome         = "
╔══════════════════════════════════════╗
║ Добро пожаловать в SpotLessByGuxta для Windows ║
╚══════════════════════════════════════╝"
    ...
    NewV2           = "Ваша версия Spotify ({0}) не тестировалась. Стабильная версия для SpotLessByGuxta — {1}"
    ...
    Spicetify       = "Обнаружен Spicetify, он должен быть установлен после SpotLessByGuxta, открыть рекомендуемые действия в FAQ ? [Y/N]"
    NoRestore       = "SpotLessByGuxta уже был установлен, но файл для восстановления xpui.bak не найден. `nУдалите клиент Spotify и снова запустите Install.bat"
