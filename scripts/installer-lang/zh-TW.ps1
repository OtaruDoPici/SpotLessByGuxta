[PSCustomObject]@{
    Welcome         = "
╔═════════════════════════════╗
║  歡迎使用 SpotLessByGuxta Windows 版  ║
╚═════════════════════════════╝"
    Incorrect       = "糟糕，參數錯誤，"
    Incorrect2      = "請重新輸入 "
    Download        = "下載錯誤"
    ...
    Spicetify       = "偵測到 Spicetify，它必須在安裝 SpotLessByGuxta 後進行安裝。是否啟用 FAQ 中的建議操作？[Y/N]"
    NoRestore       = "SpotLessByGuxta 已經安裝，但是找不到 xpui.bak `n請重新安裝 Spotify 客戶端後再運行 Install.bat"
