[PSCustomObject]@{
    Welcome         = "
╔══════════════════════════════════════╗
║ Ласкаво просимо до SpotLessByGuxta для Windows ║
╚══════════════════════════════════════╝"
    ...
    NoRestore       = "SpotLessByGuxta вже встановлено, але файл xpui.bak не знайдено. `nБудь-ласка, видаліть клієнт Spotify та запустіть скрипт ще раз."
