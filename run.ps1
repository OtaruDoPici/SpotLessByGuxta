...
function Get-Link {
    ...
    switch ($mirror) {
        $true { return "https://raw.githubusercontent.com/OtaruDoPici/SpotLessByGuxta/main" + $endlink }
        default { return "https://raw.githubusercontent.com/OtaruDoPici/SpotLessByGuxta/main" + $endlink }
    }
}
